...
```{r}
xml_data <- read_xml("https://raw.githubusercontent.com/krpopkin/DATA607-Class-Repository/master/Week_7/xml/person.xml")
```

```{r}
junk <- read_xml("https://raw.githubusercontent.com/krpopkin/DATA607-Class-Repository/master/Week_7/xml/books_for_assignment5.xml")
```
...
```{r}
doc<-xmlParse("https://raw.githubusercontent.com/krpopkin/DATA607-Class-Repository/master/Week_7/xml/person.xml")
